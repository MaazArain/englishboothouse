    ...
    <div class="layout_padding gallery_section">
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">{{ $product->product_name }}</p>
						<div class="shoes_icon"><a href="{{route('details' , ['id' => $product->id])}}"><img src="/product_images/medium-{{$product['product_image'] }}" class="ml-2 "></a></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="images/star-icon.png"></a></li>
