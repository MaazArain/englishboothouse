          ...
          <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <button type="button" class="btn btn-success btn-rounded btn-fw mb-2 float-end"><a href="{{route('list_colors')}}" class="text-decoration-none text-white">List Colors</a></button>
                    ...
                    <form class="forms-sample form" action="{{route('update_colors', ['id' => $colors->id])}}" method="post">
                      @csrf
                      <div class="form-group">
                        <label for="exampleInputName1">Colors Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="colors_name" placeholder="Enter a Name" value="{{ $colors->colors_name }}">
                      </div>
                     <input type="submit" class="btn btn-danger" name="update_colors" value="UpdateColors">
