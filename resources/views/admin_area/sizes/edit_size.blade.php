          ...
          <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <button type="button" class="btn btn-success btn-rounded btn-fw mb-2 float-end"><a href="{{route('list_size')}}" class="text-decoration-none text-white">List Sizes</a></button>
                    ...
                    <form class="forms-sample form" action="{{route('update_size', ['id' => $sizes->id])}}" method="post">
                      @csrf
                      <div class="form-group">
                        <label for="exampleInputName1">Size Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="size_name" placeholder="Enter a Edit Size Name" value="{{ $sizes->size_name }}">
                      </div>
                     <input type="submit" class="btn btn-primary" name="add_size" value="UpdateSizes">
