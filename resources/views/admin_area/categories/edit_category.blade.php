          ...
          <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  ...
                  <button type="button" class="btn btn-success btn-rounded btn-fw mb-2 float-end"><a href="{{route('list_category')}}" class="text-decoration-none text-white">List Category</a></button>
                    ...
                    <form class="forms-sample form" action="{{route('update_category', ['id' => $categories->id])}}" method="post">
                      @csrf
                      <div class="form-group">
                        <label for="exampleInputName1">Name</label>
                        <input type="text" class="form-control" id="exampleInputName1" name="name" placeholder="Enter a Name" value="{{ $categories->name }}">
                      </div>
                     <input type="submit" class="btn btn-primary" name="add_category" value="UpdateCategory">
